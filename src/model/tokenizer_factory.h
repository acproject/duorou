...
// Register a TextProcessor creator by tokenizer model key (e.g., "llama", "gpt2")
void registerTextProcessor(const std::string& key, TextProcessorCreator creator);

// Create TextProcessor by reading tokenizer-related kv (e.g., tokenizer.ggml.model / .pre)
